...
return function(Library)
    ...
    function Toggle.new(config)
        ...
        -- glow roxo no track (visível quando ligado)
        self._trackGlow = RenderEngine:ApplyGlow(self.Track, theme.Colors.AccentGlow, 2)
        self._trackGlow.Transparency = self.Value and 0.35 or 1
    ...
    function Toggle:Set(value)
        ...
        if self._trackGlow then
            RenderEngine:Animate(self._trackGlow, { Transparency = value and 0.35 or 1 })
        end
