...
return function(Library)
    ...
    function Button.new(config)
        ...
        -- glow roxo sutil (invisível até o hover)
        self._glow = RenderEngine:ApplyGlow(self.Instance, theme.Colors.AccentGlow, 1.5)
        ...
        self.Maid:Add(self.Instance.MouseEnter:Connect(function()
            ...
            RenderEngine:Animate(self._glow, { Transparency = primary and 0.4 or 0.6 })
        ...
        self.Maid:Add(self.Instance.MouseLeave:Connect(function()
            ...
            RenderEngine:Animate(self._glow, { Transparency = 1 })
            if self._stroke then
